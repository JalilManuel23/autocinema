  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="../pages/cartelera.html">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        ...
                        <form id="formAgregar" method="POST">
                          ...
                          <div class="row">
                            <div class="col-6 mb-3">
                              ...
                              <small id="textAyuda" class="text-muted"> Imagen a cargar para película.</small>
                            </div>
                            <div class="col-6 mb-3">
                              <label for="tituloImg" minlength="2" maxlength="30">Título de la imagen</label>
                              <input id="tituloImg" type="text" name="nombre_comercial" class="form-control" tabindex="1" aria-describedby="tituloAyuda" required>
                              <small id="textAyuda" class="text-muted"> Nombre de Imagen</small>
                            </div>
                          </div>
                          <div class="row">
                            <div class="col-6 mb-3">
                              <label for="generoPelicula" class="form-label">Genero de la película</label>
