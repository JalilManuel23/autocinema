<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="animacion navbar-brand m-0" href=" ../pages/dashboard.php">
        <img src="../assets/img/logos/logo.png" class="navbar-brand-img h-100" alt="">
        <span class="animacion2 ms-1 font-weight-bold">Auto Cinema</span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
        <?php $clase = ($activo == "Perfil") ? "nav-link active" : "nav-link"; ?>
        ...
        <li class="nav-item">
        <?php $clase = ($activo == "Facturación") ? "nav-link active" : "nav-link"; ?>
